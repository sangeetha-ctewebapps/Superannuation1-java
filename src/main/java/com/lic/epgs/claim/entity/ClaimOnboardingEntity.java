...
@Setter
@Entity
@Table(name = "CLAIM_ONBORADING")
public class ClaimOnboardingEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CLAIM_ONB_SEQUENCE")
	@SequenceGenerator(name = "CLAIM_ONB_SEQUENCE", sequenceName = "CLAIM_ONB_SEQUENCE", allocationSize = 1)
	...
	private List<ClaimEntity> claim;
}
