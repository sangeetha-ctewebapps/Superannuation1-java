...
//@Setter
//@Entity
//@Table(name = "POLICY_SRV_MBR_APOTE_TEMP")
//public class PolicyServiceMemberApponinteeTempEntity implements Serializable {
//	private static final long serialVersionUID = 1L;
//	
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_MBR_APOTE_TEMP_SEQUENCE")
//	@SequenceGenerator(name = "POL_MBR_APOTE_TEMP_SEQUENCE", sequenceName = "POL_MBR_APOTE_TEMP_SEQ", allocationSize = 1)
