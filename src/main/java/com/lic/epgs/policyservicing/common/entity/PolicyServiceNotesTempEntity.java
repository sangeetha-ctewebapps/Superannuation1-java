...
@Setter
@Entity
@Table(name = "POLICY_SERVICE_NOTE_TEMP")
public class PolicyServiceNotesTempEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_SRV_NOTE_SEQUENCE")
	@SequenceGenerator(name = "POL_SRV_NOTE_SEQUENCE", sequenceName = "POL_SRV_NOTE_SEQ", allocationSize = 1)
