...
@Setter
@Entity
@Table(name = "POLICY_SERVICE_DOC_TEMP")
public class PolicyServiceDocumentTempEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "POL_DOC_SEQUENCE")
	@SequenceGenerator(name = "POL_DOC_SEQUENCE", sequenceName = "POL_DOC_SEQ", allocationSize = 1)
